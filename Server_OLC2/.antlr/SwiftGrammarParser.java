...
public class SwiftGrammarParser extends Parser {
	...
	public static final int
		...
		RULE_whilestmt = 12, RULE_forstmt = 13, RULE_declarationstmt = 14, RULE_types = 15, 
		RULE_expr = 16, RULE_listParams = 17, RULE_listArray = 18, RULE_callFunction = 19, 
		RULE_listParamsCall = 20, RULE_listStructExp = 21;
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 5100342656L) != 0) );
	...
	public final DeclarationstmtContext declarationstmt() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_declarationstmt);
		try {
			setState(286);
			_errHandler.sync(this);
	...
	private ListStructExpContext listStructExp(int _p) throws RecognitionException {
		...
		int _startState = 42;
		enterRecursionRule(_localctx, 42, RULE_listStructExp, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
